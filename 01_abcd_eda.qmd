...
```{r,include=FALSE}
# Defaults to baseline data - alternatively, pass a vector of eventnames
...
print(paste("ncols of ELA data used for Brieant el al. 2023 analysis:",
            ncol(ela_data_brieant)))
```
...
vars_ela_orendain <- setdiff(names(ela_data), 
                             c("src_subject_id", "eventname", "rel_family_id"))
